...
DEFAULT_CONFIGS_PATH_ES=${PROJECT_STACK}/default-configs/elasticsearch-local
...
echo "Logs are at $LOGS_DIR"
echo "Data is at $DATA_DIR"
echo "Pid is at $PIDS_DIR/$NODE_NAME.pid
...
alias tail-elasticsearch-logs-local="tail -F $DATA_DIR/*/${CLUSTER_NAME_LOCAL}.log"
